//
//  AudioLiveDvrViewController.swift
//  SDKQAiOS
//
//  Audio Live DVR: mismos IDs y config que Android AudioLiveDvrActivity.
...
class AudioLiveDvrViewController: UIViewController {

    private let baseId = "632c9b23d1dcd7027f32f7fe"
