//
//  VideoLocalViewController.swift
//  SDKQAiOS
//
//  Video Local: mismo enfoque que Android VideoLocalActivity.
//  Reproduce un archivo de video del bundle (sample_video.mp4).
//

import UIKit
import MediastreamPlatformSDKiOS

class VideoLocalViewController: UIViewController {
